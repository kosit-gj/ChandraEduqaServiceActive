...
public class ImakeXML implements Serializable {
	...
	public String[] getOtherKeySearch() {
		return otherKeySearch;
	}
	public void setOtherKeySearch(String[] otherKeySearch) {
		this.otherKeySearch = otherKeySearch;
	}
